# AUTOGENERATED! DO NOT EDIT! File to edit: path_config.ipynb (unless otherwise specified).

__all__ = ['config_file_path', 'f', 'config', 'stats_can_regions', 'stats_can_feature_by_ids_dir', 'target_path',
           'target_features', 'feature_encoding_map_dir', 'polygon_path', 'target_df_regions']
